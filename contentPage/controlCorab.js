...
function makeCorab() {
  ...
  corab.innerHTML = ` <div>
                ...
                <div>
                    <input class="corab corab-location" id="cc" contenteditable="true" placeholder="위치 혹은 장소를 입력해 주세요." />

                    <div class="corab corab-content" id="aa" name="content" contenteditable="true"></div>
                </div>
